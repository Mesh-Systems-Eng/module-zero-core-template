...
public class ExternalAuthManager(IIocResolver iocResolver, IExternalAuthConfiguration externalAuthConfiguration) : IExternalAuthManager, ITransientDependency
{
    private readonly IIocResolver _iocResolver = iocResolver;
    private readonly IExternalAuthConfiguration _externalAuthConfiguration = externalAuthConfiguration;
