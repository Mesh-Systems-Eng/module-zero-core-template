...
public class MultiTenantMigrateExecuter(
    ...
    Log log,
    IDbPerTenantConnectionStringResolver connectionStringResolver) : ITransientDependency
{
    private readonly Log _log = log;
    private readonly AbpZeroDbMigrator _migrator = migrator;
    private readonly IRepository<Tenant> _tenantRepository = tenantRepository;
    private readonly IDbPerTenantConnectionStringResolver _connectionStringResolver = connectionStringResolver;
